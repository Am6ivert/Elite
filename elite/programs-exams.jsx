...
const EXAMS = [
  ...
  { name: "CENT", badge: "Для Кыргызстана",
    desc: "Централизованный экзамен для поступления в вузы Кыргызстана. Высокий балл CENT открывает доступ к государственным грантам. Готовим к математике, логике и языковым секциям.",
    diff: "Средне", price: "Бесплатно", for: "Кыргызстан" },
];
