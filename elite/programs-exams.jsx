...
const PROGRAMS = {
  "Бакалавриат": { level: "Бакалавр", items: [
    ...
    { name: "Business Administration", flag: "US", country: "США", dur: "4 года", price: "от $10 000/год", schol: "ср. $32 000", specs: "Маркетинг · Финансы", field: "Business", guar: true },
    { name: "Инженерия", flag: "IT", country: "Италия", dur: "3 года", price: "от €2 100/год", schol: "гранты DSU", specs: "Механика · Авиа · Авто", field: "Engineering", guar: true },
    { name: "Медицина", flag: "IT", country: "Италия", dur: "6 лет", price: "от €2 200/год", schol: "гранты DSU", specs: "На английском · IMAT", field: "Medicine" },
    { name: "Дизайн и архитектура", flag: "IT", country: "Италия", dur: "3 года", price: "от €2 600/год", schol: "ср. $9 000", specs: "Product · Interior · Fashion", field: "Design" },
    { name: "Право", flag: "AT", country: "Австрия", dur: "3 года", price: "от €726/год", schol: "почти бесплатно", specs: "Международное · ЕС", field: "Law", guar: true },
  ]},
  "Магистратура": { level: "Магистр", items: [
    ...
    { name: "Engineering (MSc)", flag: "DE", country: "Германия", dur: "2 года", price: "€0 в гос. вузах", schol: "DAAD грант", specs: "Robotics · Energy", field: "Engineering" },
    { name: "Management (MSc)", flag: "AT", country: "Австрия", dur: "2 года", price: "от €726/год", schol: "почти бесплатно", specs: "Стратегия · Консалтинг", field: "Business", guar: true },
    { name: "Finance & Economics", flag: "IT", country: "Италия", dur: "2 года", price: "от €2 500/год", schol: "гранты DSU", specs: "Banking · Fintech", field: "Economics", guar: true },
    { name: "Public Health (MPH)", flag: "US", country: "США", dur: "2 года", price: "от $20 000/год", schol: "ср. $30 000", specs: "Эпидемиология", field: "Medicine" },
    { name: "Design (MA)", flag: "IT", country: "Италия", dur: "2 года", price: "от €2 600/год", schol: "ср. €5 000", specs: "Fashion · Product", field: "Design" },
  ]},
  "МВА": { level: "Магистр", items: [
    { name: "Full-time MBA", flag: "US", country: "США", dur: "2 года", price: "от $25 000/год", schol: "ср. $45 000", specs: "Strategy · Finance", field: "Business" },
    { name: "Global MBA", flag: "MY", country: "Малайзия", dur: "1–1.5 года", price: "от $9 000", schol: "скидки до 50%", specs: "Британский диплом", field: "Business", guar: true },
    { name: "Tech MBA", flag: "US", country: "США", dur: "1.5 года", price: "от $29 000/год", schol: "ср. $35 000", specs: "Product · Startups", field: "Business" },
  ]},
  "PhD": { level: "PhD", items: [
    ...
    { name: "PhD in Engineering", flag: "DE", country: "Германия", dur: "3–4 года", price: "Финансируется", schol: "оплата позиции", specs: "Applied research", field: "Engineering" },
    { name: "PhD in Economics", flag: "AT", country: "Австрия", dur: "3–4 года", price: "от €726/год", schol: "ассистентские позиции", specs: "Econometrics", field: "Economics" },
  ]},
